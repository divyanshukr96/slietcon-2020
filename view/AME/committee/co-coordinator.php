...
<section class="position-relative">
    <div id="co-coordinator" class="position-absolute" style="top: -70px; opacity: 0"></div>
    <div class="heading">
        <div class="container px-0">
            <h5 class="font-weight-bold p-3">Co-Coordinator</h5>
        </div>
    </div>
    <div class="container">
        <div class="row text-center mt-md-3 mt-lg-4">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 mx-auto">
                <img src="../../assets/images/co-coordinator/js-gill.jpg" class="img-thumbnail"
                     alt="Coordinator">
                <div class="py-2">
                    <h6 class="font-weight-bold">Dr. Jaspal Singh Gill</h6>
                    <h6>AsP, ME</h6>
                </div>
            </div>
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 mx-auto">
                <img src="../../assets/images/co-coordinator/harish-kumar-arya.jpg" alt="Coordinator"
                     class="img-thumbnail">
                <div class="py-2">
                    <h6 class="font-weight-bold">Dr. Harish Kumar Arya</h6>
                    <h6>AP, ME</h6>
                </div>
            </div>
