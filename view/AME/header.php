...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/theme-ame.css">
...
<section id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-light bg-orange transparent rounded-0 fixed-top side-control">
            ...
            <a class="navbar-brand mr-auto" href="/AME">
                <span class="large">International conference on “Advances in Mechanical Engineering” (AME- 2020)</span>
                <span class="small"
                      title="International conference on “Advances in Mechanical Engineering” (AME- 2020)">AME - 2020</span>
            </a>
        </nav>
