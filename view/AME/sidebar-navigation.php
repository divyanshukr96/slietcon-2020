...
<div id="sidebar-wrapper" class="bg-">
    <ul class="sidebar-nav">
        ...
        <li>
            <a href="/ame/conference-tracks">Conferences</a>
        </li>
        <li class="dropdown">
        ...
        <li><a href="/ame/call-for-paper">Call for Paper</a></li>

        <li><a href="/ame/dates">Important Dates</a></li>

        <li><a href="/ame/program-schedule">Program Schedule</a></li>


        <li><a href="/ame/venue">Venue</a></li>
        <li><a href="/ame/registration">Registration</a></li>
