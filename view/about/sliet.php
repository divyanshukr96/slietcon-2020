    ...
    <section class="container p-0">
        <div class="position-relative">
            ...
            <div class="overlay p-2 bg-light">
                <h4 class="m-0 font-weight-bold">Sant Longowal Institute of Engineering & Technology, Longowal</h4>
            </div>
        </div>
        <div class="text-justify">
            <p class="p-4">
                ...
                through formal and non formal education, entrepreneurship and research to meet the changing need of
                society. The institute has a sprawling area of 447 acres of land. The campus of the institute extends a
                beautiful and well developed lush green area with many topographically featured picturesque landscape,
