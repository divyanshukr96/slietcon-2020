...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/theme-aisct.css">
...
<section id="wrapper">
    ...
    <?php require_once TEMPLATE_PATH . '/aisct/sidebar-navigation.php' ?>
    <!-- /#sidebar-wrapper -->
    ...
    <div id="page-content-wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-light bg-orange transparent rounded-0 fixed-top side-control">
            ...
            <a class="navbar-brand mr-auto" href="/AISCT">
                <span class="large">International conference on “Advances in Soft Computing Techniques” (AISCT - 2020)</span>
                <span class="small"
                      title="International conference on “Advances in Soft Computing Techniques” (AISCT - 2020)">AISCT - 2020</span>
            </a>
        </nav>
