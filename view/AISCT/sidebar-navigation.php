...
<div id="sidebar-wrapper" class="bg-">
    <ul class="sidebar-nav">
        ...
        <li>
            <a href="/aisct/conference-tracks">Conferences</a>
        </li>
        <li class="dropdown">
...
<!--                <a class="dropdown-item" href="/about/food-department">Department of Food Engineering and Technology</a>-->
        ...
        <li><a href="/aisct/call-for-paper">Call for Paper</a></li>
        ...
        <li><a href="/aisct/registration">Registration</a></li>

        <li class="dropdown">
            <a class="dropdown-toggle" href="#" id="committee" role="button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">Committees
            </a>

            <div class="dropdown-menu rounded-0" aria-labelledby="committee">
                <a class="dropdown-item" href="/aisct/committee">Patron / Co-Patron</a>
                <a class="dropdown-item" href="/aisct/committee#national-advisory">National Advisory Committee</a>
                <a class="dropdown-item" href="/aisct/committee#chairperson">Chairperson</a>
                <a class="dropdown-item" href="/aisct/committee#coordinator">Coordinator</a>
            </div>
        </li>
        ...
        <li><a href="/aisct/accommodation">Accommodation </a></li>

        <!--        <li><a href="/sliet-at-a-glance">SLIET at a Glance</a></li>-->

        <li><a href="/aisct/glimpse-of-sliet">Glimpse of SLIET </a></li>
        <li><a href="/aisct/places-to-visit">Places to visit around</a></li>
